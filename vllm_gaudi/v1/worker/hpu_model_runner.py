...
def trim_attn_metadata(metadata: HPUAttentionMetadataV1) -> object:
    ...
    attention_metadata = subtuple(metadata, 'TrimmedAttentionMetadata', [
        ...
        'window_block_usage', 'window_block_groups', 'window_attn_bias', 'prep_initial_states', 'has_initial_states_p',
        'last_chunk_indices_p', 'state_indices_tensor', 'query_start_loc', 'query_start_loc_p', 'padding_mask_flat'
    ])
...
class HPUModelRunner(KVConnectorModelRunnerMixin):
    ...
    def _form_prefill_batch(self, contents):
        ...
        if self.num_mamba_layers > 0:
            ...
            block_table_cpu_tensor = self.input_batch.block_table[
                self._get_attention_grup_id_for_hybrid()].get_cpu_tensor()
    ...
    def _prepare_decode_inputs(self,
        ...
        return self._create_decode_input_data(
            ...
            self.input_batch.block_table[self._get_attention_grup_id_for_hybrid()].get_cpu_tensor(),
