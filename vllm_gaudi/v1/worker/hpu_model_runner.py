...
class HPUModelRunner(KVConnectorModelRunnerMixin):
    ...
    # TODO: what needs to be added here for Mamba
    ...
    def _form_prefill_batch(self, contents):
        ...
        # compute prefix caching block indices
        ...
        block_idx_last_scheduled_token_cpu = (
            cdiv(query_lens, mamba_block_size) - 1
        )
        ...
        block_idx_last_scheduled_p = async_h2d_copy(block_idx_last_scheduled_cpu, dtype=torch.int32)
        ...
        attn_metadata = HPUAttentionMetadataV1.make_prefill_metadata(seq_lens_tensor=query_lens,
                                                                     ...
                                                                     block_idx_last_scheduled_p=block_idx_last_scheduled_p)
